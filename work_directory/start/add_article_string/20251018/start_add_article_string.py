# python work_directory/start/add_article_string/20251018/start_add_article_string.py
...
# インストールする必要のあるコマンドが特に無し用
pattern = r"""<h5 class="wp-block-heading">MSYS2 MINGW64</h5>"""
patternRowNumber=3
selectedElementNumber=2
addString="""<!-- wp:code {"backgroundColor":"cyan-bluish-gray","textColor":"#24292eff","fontSize":"1.125rem"} -->
<pre class="wp-block-code has-24292-eff-color has-cyan-bluish-gray-background-color has-text-color has-background has-1-125-rem-font-size"><code>特にありません</code></pre>
